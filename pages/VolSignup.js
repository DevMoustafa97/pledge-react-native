...
export default function VolSignup({navigation}) {
  ...
  return (
    <ImageBackground source = {require('../assets/background.png')} style = {styles.background}>
                    ...
                    <Text style = {styles.textHeader} >Sign up as Volunteer</Text>
                    </View>
        <View style = {styles.root}>
        <Formik
            initialValues = {{Firstname:'',Lastname:'', Email:'', password:'',phone:'',age:'',type:'volunteer'}}
            ...
            onSubmit = {(values) => {
                ...
                Alert.alert(
                  'Pledge',
                  'Successfully signed up as volunteer log in to proceed',
                  [
